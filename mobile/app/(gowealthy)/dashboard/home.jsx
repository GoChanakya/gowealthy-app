...
//   const secStatus = J.security;
//   const secPct = secStatus ? Math.min(100, Math.round((secStatus.months ? 0 : 0))) : 0; // day-1 baseline, always 0%
...
//       >
//         {/* ---- HOME: status + greeting + progress + hero ---- */}
...
//               <Text style={styles.progLabel}>YOUR PROGRESS</Text>
//               <Text style={styles.progPct}>15%</Text>
//             </View>
//             <View style={styles.progTrack}>
//               <View style={[styles.progFill, { width: "15%" }]} />
//             </View>
//             <Text style={styles.progSub}>
//               {A.goals.length} goal{A.goals.length !== 1 ? "s" : ""} mapped · day {planDay}
//             </Text>
//           </View>
...
//             <Text style={styles.heroCap}>{inrFull(workingTotal)}/mo, compounding at 12%/yr.</Text>
...
//           <Text style={[styles.eyebrowOnDark]}>Your move today</Text>
//           <Text style={styles.moveH3}>Build your buffer.</Text>
//           <Pressable
//             style={[styles.moveBtn, moveSet && styles.moveBtnSet]}
//             onPress={() => setMoveSet(true)}
//           >
//             <Text style={[styles.moveBtnText, moveSet && styles.moveBtnTextSet]}>
//               {moveSet ? "✓ Automatic transfer set!" : `Set up ${inrFull(topGoal.amount)}/mo →`}
//             </Text>
//           </Pressable>
//           <Text style={styles.moveWhy}>
//             Toward <Text style={styles.bOnDark}>{topGoal.name}</Text>, your #1 priority.
//           </Text>
//         </View>

//         {/* ---- ROUTED ---- */}
//         <View style={styles.dblock} onLayout={(e) => (sectionY.current.secInvest = e.nativeEvent.layout.y)}>
//           <Eyebrow>How your ₹ is routed this month</Eyebrow>
//           <View style={styles.routedBar}>
//             {buckets.map((b) => {
//               const w = (b.amount / bucketsTot) * 100;
//               return (
//                 <View key={b.key} style={[styles.routedSeg, { width: `${w}%`, backgroundColor: b.color }]}>
//                   {w > 6 && <Text style={styles.routedAmt}>{inrFull(b.amount)}</Text>}
//                   {w > 11 && (
//                     <Text style={styles.routedLabel} numberOfLines={1}>
//                       {b.name}
//                     </Text>
//                   )}
//                 </View>
...
//             })}
//           </View>
//           <Text style={styles.routedNote}>
//             Placed by <Text style={styles.b}>priority order</Text> — {topGoal.name} is #1.
//           </Text>
//         </View>
...
//               const rankLabel = ["🥇 Priority 1", "🥈 Priority 2", "🥉 Priority 3", "⭐ Priority 4"][i] || `#${i + 1}`;
//               const isLead = i === 0;
//               const funded = isLead && moveSet;
...
// /* ---- small journey node subcomponent — draws the connecting "comet"
//    trail line between dots, with a glowing head on "now" ---- */
// function JourneyNode({ label, sub, now, isLast }) {
//   return (
//     <View style={styles.jNode}>
//       {!isLast && <View style={[styles.jLine, now && styles.jLineNow]} />}
//       <View style={styles.jDotWrap}>
//         {now && <View style={styles.jDotGlow} />}
...
//   gradText: { color: C.o2 },
//   greetSub: { color: C.muted, fontSize: 13.5, lineHeight: 20, marginBottom: 18, maxWidth: 330 },

//   progBox: { borderWidth: 1, borderColor: C.line, borderRadius: RADIUS.sm, backgroundColor: C.surface, padding: 13, marginBottom: 4 },
//   progTop: { flexDirection: "row", justifyContent: "space-between", marginBottom: 8 },
//   progLabel: { fontSize: 9, letterSpacing: 1.6, color: C.muted, fontWeight: "700" },
//   progPct: { color: C.o2, fontSize: 13, fontWeight: "700" },
//   progTrack: { height: 5, backgroundColor: "#241a24", borderRadius: 99, overflow: "hidden" },
//   progFill: { height: "100%", backgroundColor: C.gold },
//   progSub: { fontSize: 11, color: C.muted, marginTop: 8 },

//   heroBlock: { paddingTop: 22, paddingBottom: 4 },
//   heroNum: { fontSize: 46, fontWeight: "800", color: C.o, marginVertical: 10, fontFamily: FONT.display },
//   heroCap: { fontSize: 12.5, color: C.muted, lineHeight: 19, maxWidth: 330 },
//   heroMileBox: {
//     marginTop: 20,
//     padding: 15,
//     borderWidth: 1,
...
//   /* journey — dot + connecting "comet" trail line, glow on "now" */
...
//   moveH3: { fontSize: 24, fontWeight: "800", color: "#fff", marginVertical: 12 },
//   moveBtn: { backgroundColor: "#141018", borderRadius: 13, paddingVertical: 14, paddingHorizontal: 18, alignItems: "center" },
//   moveBtnSet: { backgroundColor: "#0f2a1c" },
//   moveBtnText: { color: "#fff", fontWeight: "700", fontSize: 14.5 },
//   moveBtnTextSet: { color: "#7fe8b6" },
//   moveWhy: { fontSize: 12.5, lineHeight: 19, color: "rgba(255,255,255,0.94)", marginTop: 14 },
//   bOnDark: { fontFamily: FONT.bodyBold, color: "#fff" },

//   /* routed */
//   routedBar: { flexDirection: "row", height: 56, borderRadius: 14, overflow: "hidden", borderWidth: 1, borderColor: C.line },
//   routedSeg: { justifyContent: "center", paddingLeft: 9 },
//   routedAmt: { fontSize: 12, fontWeight: "800", color: "#1a1006" },
//   routedLabel: { fontSize: 8, fontWeight: "700", color: "#1a1006", opacity: 0.82 },
//   routedNote: { fontSize: 12, color: C.muted, marginTop: 12, lineHeight: 19 },

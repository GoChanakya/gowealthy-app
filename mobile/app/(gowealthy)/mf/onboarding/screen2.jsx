...
// ============================================================
// SCREEN 2 — FULL REPLACEMENT FILE
// Aadhaar OCR + KYC Check (NSE API)
// ============================================================
//
// WHAT CHANGED vs your current screen2.jsx:
//   1. saveToFirebase  → writes to mf_onboarding/{phone} (not users/{phone})
//   2. handleContinue → reads PAN from Firestore, calls NSE KYC Check,
//                       routes to screen4 (KYC found) or screen3 (fresh KYC)
//   3. Imports        → added getDoc + NSE_SERVICE_URL constant
//   4. State          → added isCheckingKYC + kycResult
//   5. UI             → button shows "Checking KYC..." during NSE call
//
// BACKEND: /api/nse/kyc-check already exists in your server.js — no changes needed.
// ============================================================

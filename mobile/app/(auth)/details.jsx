...
const s = StyleSheet.create({
  ...
  cardTitle:      { fontSize: 24, fontWeight: '800', color: C.white, marginBottom: 8, letterSpacing: -0.4, fontFamily: 'Syne_700Bold' },
  cardSub:        { fontSize: 13, color: C.gray500, lineHeight: 20, marginBottom: 24, fontFamily: 'Inter_400Regular' },
  inputLabel:     { fontSize: 11, fontWeight: '700', color: 'rgba(255,255,255,0.35)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 1.2, fontFamily: 'Inter_700Bold' },
  ...
  input:          { flex: 1, fontSize: 16, color: C.white, paddingHorizontal: 14, paddingVertical: 15, fontWeight: '500', fontFamily: 'Inter_500Medium' },
  ...
  skipText:       { fontSize: 13, color: C.gray500, fontWeight: '500', fontFamily: 'Inter_500Medium' },

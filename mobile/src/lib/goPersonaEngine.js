...
export const QUIZ = [
  { id:'q1', tag:'Scenario 1 · Your money energy', title:'What’s your money energy right now?', sub:'No wrong answer — go with your gut.', type:'single',
    options:[
      { text:'Chasing the next big win', icon:'Flame', dH:1, dC:-1, dO:1 },
      { text:'Protecting what I’ve already built', icon:'Shield', dH:-1, dC:2, dO:-1 },
      { text:'Honestly, still figuring it out', icon:'Compass', dH:-2, dC:-2, dO:0 },
      { text:'Building something, brick by brick', icon:'Blocks', dH:-1, dC:2, dO:0 }
    ]},
  { id:'q2', tag:'Scenario 2 · The windfall', title:'₹1,00,000 just landed. No strings.', sub:'What do you actually do with it?', type:'single',
    options:[
      { text:'Park it somewhere safe — FD or savings', icon:'Landmark', dH:-1, dC:0, dO:-1 },
      { text:'Invest all of it — put it to work', icon:'TrendingUp', dH:2, dC:0, dO:1 },
      { text:'Book the trip I keep putting off', icon:'Plane', dH:2, dC:-2, dO:0 },
      { text:'Split it — invest, save, and enjoy some', icon:'Scale', dH:2, dC:2, dO:0 }
    ]},
  { id:'q3', tag:'Scenario 3 · Three gut calls', title:'Three fast calls. Don’t overthink.', sub:'Tap one in each row.', type:'triple',
    rows:[
      { q:'A flash-deal flight expires in 10 minutes.', options:[
        { text:'Buy it. Right now.', icon:'Zap', dH:1, dC:-1, dO:1 },
        { text:'Let it go — I’ll find better.', icon:'Snowflake', dH:-1, dC:1, dO:0 } ] },
      { q:'A friend says "this stock is about to explode."', options:[
        { text:'Put money in on the tip.', icon:'Handshake', dH:2, dC:-2, dO:1 },
        { text:'I research it first.', icon:'Search', dH:-1, dC:1, dO:0 } ] },
      { q:'₹80,000 now, or ₹1,50,000 in 18 months.', options:[
        { text:'₹80K now.', icon:'Banknote', dH:2, dC:-1, dO:0 },
        { text:'₹1.5L later — obvious math.', icon:'Calculator', dH:-2, dC:1, dO:2 } ] }
    ]},
  { id:'q4', tag:'Scenario 4 · The life tile', title:'Pick the future that feels most like yours.', sub:'Zero financial thinking — pure instinct.', type:'single',
    options:[
      { text:'Free — answers to no one', icon:'Bird', dH:1, dC:-1, dO:2 },
      { text:'Secure — nothing knocks me over', icon:'Shield', dH:-1, dC:2, dO:-2 },
      { text:'Wealthy — genuinely rich', icon:'Gem', dH:0, dC:2, dO:1 },
      { text:'Impactful — my work outlives me', icon:'Sprout', dH:-1, dC:0, dO:-2 }
    ]},
  { id:'q5', tag:'Scenario 5 · The crash', title:'Your portfolio drops 30% this week. Your body does what?', sub:'Be honest — there’s no right answer.', type:'single',
    options:[
      { text:'Heart spikes. I sell before it worsens.', icon:'Activity', dH:2, dC:-2, dO:-2 },
      { text:'I pull up a sheet — time to value it.', icon:'ChartBar', dH:-2, dC:1, dO:0 },
      { text:'I get excited. Buying opportunity.', icon:'Flame', dH:1, dC:-1, dO:2 },
      { text:'I stick to the plan — expected this.', icon:'Target', dH:2, dC:2, dO:0 }
    ]},
  { id:'q6', tag:'Scenario 6 · The crowd', title:'Everyone you know is buying one stock.', sub:'It’s all over your feed. You…', type:'single',
    options:[
      { text:'I’m in — not missing this.', icon:'Rocket', dH:1, dC:-2, dO:1 },
      { text:'I research it properly first.', icon:'Search', dH:-2, dC:1, dO:0 },
      { text:'I skip it — the edge is gone.', icon:'CircleSlash', dH:-1, dC:2, dO:-2 }
    ]},
  { id:'q8', tag:'Scenario 7 · The mirror', title:'How do you really behave with money?', sub:'Pick the most honest label.', type:'single',
    options:[
      { text:'Disciplined — rules, and I follow them', icon:'ClipboardList', dH:0, dC:2, dO:0 },
      { text:'Intuitive — I go with what feels right', icon:'Lightbulb', dH:2, dC:-1, dO:1 },
      { text:'Emotional — money stresses me out', icon:'CloudRain', dH:-2, dC:-2, dO:-1 },
      { text:'Avoidant — I know I should, I just don’t', icon:'EyeOff', dH:-1, dC:-2, dO:-2 }
    ]}
];
...
export const PERSONALITIES = [
  { key:'supreme_ruler', name:'Supreme Ruler', icon:'Crown', img:'', code:'HLH',
  ...
  { key:'masterful_strategist', name:'Masterful Strategist', icon:'Swords', img:'', code:'LHH',
  ...
  { key:'bold_pioneer', name:'Bold Pioneer', icon:'Rocket', img:'', code:'HHH',
  ...
  { key:'inspiring_storyteller', name:'Inspiring Storyteller', icon:'Megaphone', img:'', code:'HLL',
  ...
  { key:'prudent_treasurer', name:'Prudent Treasurer', icon:'Landmark', img:'', code:'LHL',
  ...
  { key:'noble_diplomat', name:'Noble Diplomat', icon:'Handshake', img:'', code:'HHL',
  ...
  { key:'enigmatic_sage', name:'Enigmatic Sage', icon:'Moon', img:'', code:'LLH',
  ...
  { key:'realistic_guardian', name:'Realistic Guardian', icon:'Shield', img:'', code:'LLL',
...
export const PRI_ICON = ['1', '2', '3', '4'];

export const B1_MSG = ['Reading your answers', 'Scoring your instincts', 'Mapping how you think', 'Matching your persona', 'Done'];
export const B1_ICON = ['Compass', 'Zap', 'Target', 'Crown', 'Check'];
...
/* ============================================================
   ...
   ============================================================ */
export const LIVING = [
  { label: 'Living with family', sub: 'Low overheads — most income is free', expense: 12000, icon: 'Users' },
  { label: 'Renting', sub: 'Rent takes ~30–45% of income', expense: 20000, icon: 'KeyRound' },
  { label: 'Own place / EMI', sub: 'Fixed EMI every month', expense: 25000, icon: 'House' },
];
...
/* ============================================================
   ...
   ============================================================ */
export const GOALS = [
  { key: 'freedom', name: 'Freedom Fund', icon: 'Bird', color: '#ff7a2e', desc: 'First financial-independence milestone', target: 1500000, infl: 0.06, defaultYears: 15, minYears: 8, maxYears: 25, instrument: 'Flexi-cap equity fund' },
  { key: 'home', name: 'Home Down Payment', icon: 'House', color: '#f7c85a', desc: 'A place that’s actually yours', target: 800000, infl: 0.07, defaultYears: 8, minYears: 3, maxYears: 15, instrument: 'Hybrid / balanced fund' },
  { key: 'travel', name: 'Travel Fund', icon: 'Plane', color: '#ff9d5c', desc: 'Trips without checking your balance', target: 150000, infl: 0.06, defaultYears: 1, minYears: 0.5, maxYears: 5, instrument: 'Liquid fund' },
  { key: 'startup', name: 'Startup Runway', icon: 'Rocket', color: '#ffb03a', desc: 'Runway to build your own thing', target: 600000, infl: 0.05, defaultYears: 6, minYears: 2, maxYears: 12, instrument: 'Debt + equity blend' },
  { key: 'education', name: 'Education Fund', icon: 'GraduationCap', color: '#ffcf7a', desc: 'A course, a degree, a certification', target: 250000, infl: 0.10, defaultYears: 3, minYears: 1, maxYears: 8, instrument: 'Short-duration bond fund' },
  { key: 'health', name: 'Health & Wellness', icon: 'HeartPulse', color: '#ffd98c', desc: 'Medical buffer, fitness, mind', target: 100000, infl: 0.09, defaultYears: 1.5, minYears: 0.5, maxYears: 5, instrument: 'Liquid / ultra-short fund' },
  { key: 'family', name: 'Family Support', icon: 'Users', color: '#ff8f3c', desc: 'Parents, siblings, kids — covered', target: 400000, infl: 0.06, defaultYears: 6, minYears: 2, maxYears: 15, instrument: 'Balanced advantage fund' },
  { key: 'impact', name: 'Impact & Giving', icon: 'Sprout', color: '#ffc247', desc: 'Causes and people beyond yourself', target: 150000, infl: 0.04, defaultYears: 5, minYears: 1, maxYears: 15, instrument: 'ESG debt fund' },
];

export const GOALS_META = {
  security: { key: 'security', name: 'Safety Net', icon: 'Shield', color: '#4fd39a', desc: '6 months of essentials — capped at 15%', instrument: 'Liquid / Overnight Fund' },
  buffer: { key: 'buffer', name: 'Buffer in Bank', icon: 'Wallet', color: '#8a7f92', desc: 'Stays liquid for whatever life throws', instrument: 'Savings account' },
};
